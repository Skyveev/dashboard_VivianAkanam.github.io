...
$tests6 = array();
$counts6=0;
while ($rows6=mysqli_fetch_array($ress6)) {
...
//    $dataPoints6= array(
//   array("label"=> "Manufacturing", "y"=> 10.0),
//   array("label"=> "Finance and Insurance", "y"=> 19.0),
//   array("label"=> "Professional Business", "y"=> 12.0),
//   array("label"=> "Energy", "y"=> 6.0),
//   array("label"=> "Retail and Wholesale", "y"=> 11.0),
//   array("label"=> "Education", "y"=> 6.0),
//   array("label"=> "Healthcare", "y"=> 6.0),
//    array("label"=> "Government", "y"=> 8.0),
//     array("label"=> "Transportation", "y"=> 13.0),
//     array("label"=> "Media", "y"=> 8.0)
// );
?>
