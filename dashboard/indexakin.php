...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset" style="background-color:red;"> 
...
<!-- end of page menu -->
    ...
    <!-- Content -->
    <div class="content container-fluid" style="background-color:lightgrey;">
      <!-- Page Header -->
 ...
 <!-- Card -->
   ...
   <!-- Begin of Graph -->
    ...
    <div class="footer" style="background-color:#3D4461; padding-left:-234px;" >
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-card navbar-dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="navbarNotificationsDropdown" style="width: 25rem;">
                      <div class="card">
                        ...
                        <ul class="nav nav-tabs nav-justified" id="notificationTab" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" href="index.html#notificationNavOne" id="notificationNavOne-tab" data-bs-toggle="tab" data-bs-target="#notificationNavOne" role="tab" aria-controls="notificationNavOne" aria-selected="true">Messages (3)</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="index.html#notificationNavTwo" id="notificationNavTwo-tab" data-bs-toggle="tab" data-bs-target="#notificationNavTwo" role="tab" aria-controls="notificationNavTwo" aria-selected="false">Archived</a>
                          </li>
                        </ul>
                        <!-- End Nav -->
                ...
                <li class="nav-item">
                  ...
                  <div class="dropdown ">
                    ...
                    <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="selectThemeDropdown">
                      <a class="dropdown-item" href="index.html#" data-icon="bi-moon-stars" data-value="auto">
                        <i class="bi-moon-stars me-2"></i>
                        <span class="text-truncate" title="Auto (system default)">Auto (system default)</span>
                      </a>
                      <a class="dropdown-item" href="index.html#" data-icon="bi-brightness-high" data-value="default">
                        <i class="bi-brightness-high me-2"></i>
                        <span class="text-truncate" title="Default (light mode)">Default (light mode)</span>
                      </a>
                      <a class="dropdown-item active" href="index.html#" data-icon="bi-moon" data-value="dark">
                    ...
                    <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu navbar-dropdown-menu-borderless navbar-dropdown-account" aria-labelledby="accountNavbarDropdown" style="width: 16rem;">
                      ...
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu navbar-dropdown-menu-borderless navbar-dropdown-sub-menu" aria-labelledby="navSubmenuPagesAccountDropdown1">
                          ...
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="index.html#"> Reset status
                          </a>
                        </div>
                      </div>
                      <!-- End Dropdown -->

                      <a class="dropdown-item" href="index.html#">Profile &amp; account</a>
                      ...
                      <a class="dropdown-item" href="index.html#">Manage team</a>
            ...
            <div class="collapse navbar-collapse" id="navbarContainerNavDropdown">
              <ul class="navbar-nav">
                ...
                <li class="hs-has-sub-menu nav-item">
                  <a id="dashboardsMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle active" href="index.html#" role="button"><i class="bi-house-door dropdown-item-icon"></i> Dashboards</a>
                ...
                <!-- Pages -->
                <li class="hs-has-sub-menu nav-item">
                  <a id="pagesMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle " href="index.html#" role="button"><i class="bi-files-alt dropdown-item-icon"></i> Pages</a>
                  ...
                  <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="pagesMegaMenu" style="min-width: 14rem;">
                    ...
                    <div class="hs-has-sub-menu nav-item">
                      <a id="usersMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="index.html#" role="button">Users</a>
                    ...
                    <!-- User Profile -->
                    <div class="hs-has-sub-menu nav-item">
                      <a id="userProfileMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="index.html#" role="button">User Profile <span class="badge bg-primary rounded-pill ms-1">5</span></a>
                      ...
                      <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="userProfileMegaMenu" style="min-width: 14rem;">
                        ...
                        <a class="dropdown-item " href="https://htmlstream.com/preview/front-dashboard-v2.1.1/user-profile-connections.html">Connections</a>
                    ...
                    <!-- Account -->
                    <div class="hs-has-sub-menu nav-item">
                      <a id="accountMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="index.html#" role="button">Account</a>
                    ...
                    <!-- E-commerce -->
                    <div class="hs-has-sub-menu nav-item">
                      <a id="ecommerceMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="index.html#" role="button">E-commerce</a>
                      ...
                      <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="ecommerceMegaMenu" style="min-width: 14rem;">
                        ...
                        <!-- Products -->
                        <div class="hs-has-sub-menu nav-item">
                          <a id="productsMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="index.html#" role="button">Products</a>
                        ...
                        <!-- Products -->
                        <div class="hs-has-sub-menu nav-item">
                          <a id="ordersMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="index.html#" role="button">Orders</a>
                        ...
                        <!-- Customers -->
                        <div class="hs-has-sub-menu nav-item">
                          <a id="customersMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="index.html#" role="button">Customers</a>
                    ...
                    <!-- Projects -->
                    <div class="hs-has-sub-menu nav-item">
                      <a id="projectsMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="index.html#" role="button">Projects</a>
                    ...
                    <!-- Project -->
                    <div class="hs-has-sub-menu nav-item">
                      <a id="projectMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="index.html#" role="button">Project</a>
                    ...
                    <!-- Authentication -->
                    <div class="hs-has-sub-menu nav-item">
                      <a id="authenticationMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="index.html#" role="button">Authentication</a>
                      ...
                      <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="authenticationMegaMenu" style="min-width: 14rem;">
                        <!-- Log In -->
                        <div class="hs-has-sub-menu nav-item">
                          <a id="loginMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="index.html#" role="button">Log In</a>
                        ...
                        <!-- Sign Up -->
                        <div class="hs-has-sub-menu nav-item">
                          <a id="signupMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="index.html#" role="button">Sign Up</a>
                        ...
                        <!-- Reset Password -->
                        <div class="hs-has-sub-menu nav-item">
                          <a id="resetPasswordMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="index.html#" role="button">Reset Password</a>
                        ...
                        <!-- Email Verification -->
                        <div class="hs-has-sub-menu nav-item">
                          <a id="emailVerificationMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="index.html#" role="button">Email Verification</a>
                        ...
                        <!-- 2-step Verification -->
                        <div class="hs-has-sub-menu nav-item">
                          <a id="2stepVerificationMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="index.html#" role="button">2-step Verification</a>
                ...
                <!-- Apps -->
                <li class="hs-has-sub-menu nav-item">
                  <a id="appsMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle " href="index.html#" role="button"><i class="bi-app-indicator dropdown-item-icon"></i> Apps</a>
    ...
    <div class="offcanvas-body">
      ...
      <div class="list-group list-group-sm list-group-flush list-group-no-gutters mb-5">
        ...
        <div class="list-group-item">
          <div class="row align-items-center">
            <div class="col-5">
              <span>Mention person <a href="index.html#">(@Brian)</a></span>
            </div>
            <!-- End Col -->
        ...
        <div class="list-group-item">
          <div class="row align-items-center">
            <div class="col-5">
              <span>Link to doc <a href="index.html#">(+Meeting notes)</a></span>
            </div>
            <!-- End Col -->
        ...
        <li class="step-item">
          <div class="step-content-wrapper">
            ...
            <div class="step-content">
              ...
              <p class="fs-5 mb-1">Added 2 files to task <a class="text-uppercase" href="index.html#"><i class="bi-journal-bookmark-fill"></i> Fd-7</a></p>
        ...
        <li class="step-item">
          <div class="step-content-wrapper">
            ...
            <div class="step-content">
              ...
              <p class="fs-5 mb-1">Marked <a class="text-uppercase" href="index.html#"><i class="bi-journal-bookmark-fill"></i> Fr-6</a> as <span class="badge bg-soft-success text-success rounded-pill"><span class="legend-indicator bg-success"></span>"Completed"</span></p>
        ...
        <li class="step-item">
          <div class="step-content-wrapper">
            ...
            <div class="step-content">
              ...
              <p class="fs-5 mb-1">Added 5 card to <a href="index.html#">Payments</a></p>
        ...
        <li class="step-item">
          <div class="step-content-wrapper">
            ...
            <div class="step-content">
              ...
              <p class="fs-5 mb-1">Marked <a class="text-uppercase" href="index.html#"><i class="bi-journal-bookmark-fill"></i> Fr-3</a> as <span class="badge bg-soft-success text-success rounded-pill"><span class="legend-indicator bg-success"></span>"Completed"</span></p>
        ...
        <li class="step-item">
          <div class="step-content-wrapper">
            ...
            <div class="step-content">
              ...
              <p class="fs-5 mb-1">Marked <a class="text-uppercase" href="index.html#"><i class="bi-journal-bookmark-fill"></i> Fr-3</a> as <span class="badge bg-soft-primary text-primary rounded-pill"><span class="legend-indicator bg-primary"></span>"In progress"</span></p>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-auto">
              <a class="d-flex align-items-center small text-body" href="index.html#">
        ...
        <div class="modal-footer">
          <div class="row align-items-center flex-grow-1 mx-n2">
            <div class="col-sm-9 mb-2 mb-sm-0">
              ...
              <p class="modal-footer-text">The public share <a href="index.html#">link settings</a>
