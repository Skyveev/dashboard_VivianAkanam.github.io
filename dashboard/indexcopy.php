...
<script src="https://cdn.canvasjs.com/jquery.canvasjs.min.js"></script>
  ...
  <aside class="js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered bg-white ">
    <div class="navbar-vertical-container" style="background-color:black;">
      <div class="navbar-vertical-footer-offset">
        <!-- Logo -->
        <a class="navbar-brand" href="index.php" aria-label="dash">
        ...
        <img class="navbar-brand-logo-mini" src="assets/svg/logos/rgu.jpg" alt="Logo" data-hs-theme-appearance="default">
        <img class="navbar-brand-logo-mini" src="assets/svg/logos-light/rgu.jpg" alt="Logo" data-hs-theme-appearance="dark">
      </a>
        ...
        <div class="navbar-vertical-content">
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            ...
            <span class="dropdown-header mt-4">Dashboard System</span>
            <small class="bi-three-dots nav-subtitle-replacer"></small>

            <div class="nav-item">
              <a class="nav-link " href="../pages/thread.html" data-placement="left" style="color:whitesmoke; ">
                <i class="bi-kanban nav-icon"></i>
                <span class="nav-link-title" style="color:whitesmoke; border: 1px solid; ">Threat Intelligence Overview</span>
              </a>
            </div>

            <div class="nav-item">
              <a class="nav-link " href="../pages/error.html" data-placement="left" style="color:whitesmoke; ">
                <i class="bi-calendar-week nav-icon"></i>
                <span class="nav-link-title" style="color:whitesmoke; border: 1px solid; ">Security Metrics and KPI</span>
              </a>
            </div>
            ...
            <div class="nav-item">
              <a class="nav-link " href="../pages/error.html" data-placement="left" style="color:whitesmoke; ">
                ...
                <span class="nav-link-title" style="color:whitesmoke; border: 1px solid; ">Compliance Status</span>
              </a>
            </div>

            <div class="nav-item">
              <a class="nav-link " href="../pages/summary.html" data-placement="left" style="color:whitesmoke; ">
                <i class="bi-folder2-open nav-icon"></i>
                <span class="nav-link-title" style="color:whitesmoke; border: 1px solid; ">Summary and Heat Map</span>
              </a>
            </div>
          </div>
  ...
  <main id="content" role="main" class="main" style="background-color:lightgrey;">
    <!-- Content -->
 ...
 <div id="chartContainer2" style="height: 390px; width:100%;"></div> 
    ...
    <div class="footer" style="background-color:lightgray;">
      <div class="row justify-content-between align-items-center">
        <div class="col">
         <p class="fs-6 mb-0">&copy; RGU. <span class="d-none d-sm-inline-block">2023 Vivian Project</span></p>
        </div>
        <!-- End Col -->
